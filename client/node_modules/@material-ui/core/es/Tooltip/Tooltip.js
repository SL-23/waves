...
class Tooltip extends React.Component {
  ...
  render() {
    ...
    return React.createElement(Manager, other, React.createElement(EventListener, {
      target: "window",
      ...
      const actualPlacement = popperProps.placement ? popperProps.placement.split('-')[0] : null;
      return React.createElement("div", {
        ...
        }, popperProps.placement ? classes[`tooltipPlacement${capitalize(actualPlacement)}`] : null)
      }, title));
    })));
  }
